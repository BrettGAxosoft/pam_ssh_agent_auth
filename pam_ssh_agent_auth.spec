...
%configure --with-selinux --enable-sudo-hack --with-mantype=man
%{__make} %{?_smp_mflags}
...
%changelog
* Fri Jun 17 2016 Jay Pearlman <jay.pearlman@gmail.com> - 0.10.2
- Built on CentOS 7.2 x86_64 for el7 x86_64
...
* Sun Sep 22 2013 Jamie Beverly <soupboy@sourceforge.net> - 0.9.6
...
- portability fixes
* Wed Jun 27 2012 Jamie Beverly <soupboy@sourceforge.net> - 0.9.4
